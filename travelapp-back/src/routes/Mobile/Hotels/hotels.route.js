...
const { makeReservation, searchHotels, payReservation, getCountriesWithCities, getHotelsByCities, httpGetHotelReservations, httpGetHotelReservation } = require('./hotels.controller');
...
router.get('/my-reservations/:id', requireJwtAuth, checkObjectID, asyncHandler(httpGetHotelReservation));
