const { validateCreateOrganizedTrip, validateMakeDiscount } = require('./organized-trips.validation')
const { validationErrors } = require('../../../middlewares/validationErrors');
const { postOrganizedtrip, getAllOrganizedTrips, getOneOrganizedTrip, makeDiscount } = require('../../../models/organized-trips.model');
...
async function httpCreateOrganizedTrip(req, res) {
    ...
    let price = trip.overall_price + trip.overall_price * (req.body.commission / 100)
