...
const { httpGetFlights, httpGetFlight, httpGetSearchPageData, httpGetFlightsOptions } = require('./flights.controller');
...
flightRouter.get('/options', requireJwtAuth, asyncHandler(httpGetFlightsOptions))
