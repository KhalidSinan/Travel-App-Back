...
const { httpMakeReservation, httpConfirmReservation, httpCancelReservation, httpPayReservation, httpGetNearestReservation, httpGetReservation, httpGetNextDestination, httpGetMyReservations } = require('./plane-reservations.controller');
...
planeReservationRouter.get('/nearest', requireJwtAuth, asyncHandler(httpGetNearestReservation))
