...
organizersRequestsRouter.get('/organizers-requests/:id/deny', requireJwtAuth, checkAdmin, checkOrganizersAdmin, checkObjectID, asyncHandler(httpDenyOrganizerRequest))
