...
announcementRequestRouter.get('/announcement-requests', requireJwtAuth, checkAdmin, checkAnnouncementsAdmin, asyncHandler(httpGetAllAnnouncementRequests));
announcementRequestRouter.get('/announcement-requests/:id', requireJwtAuth, checkAdmin, checkAnnouncementsAdmin, checkObjectID, asyncHandler(httpGetOneAnnouncementRequest));
